...
/********************************************//**
 * \brief converts integer to 24 bit hex and saves to buffer
 *
 * \return None
 ***********************************************/
...
{
    fprintf(file, "%07d ",  curr_node->address);
...
{
	FILE *file;
	char *full_file_name = (char *)malloc(strlen(file_name) + strlen(file_ending) + 1);
